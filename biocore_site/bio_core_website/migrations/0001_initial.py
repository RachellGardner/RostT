# Generated by Django 5.2 on 2025-06-17 10:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='elements', to='bio_core_website.category', verbose_name='Категория')),
            ],
        ),
        migrations.CreateModel(
            name='Product',
            fields=[
                ...
                ('element', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='products', to='bio_core_website.element', verbose_name='Элемент')),
                ('manufacturer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='products', to='bio_core_website.manufacturer', verbose_name='Производитель')),
            ],
        ),
    ]
